...
public class ScheduleEventProducer {
    private static final Logger log = LoggerFactory.getLogger(ScheduleEventProducer.class.getSimpleName());
            ...
            producer.send(producerRecord, new Callback() {
                ...
                public void onCompletion(RecordMetadata metadata, Exception e) {
                    if (e == null) {
                        ...
                        log.error("Error while sending schedule event for project {}", event.getProjectId(), e);
                    }
                }
            });
