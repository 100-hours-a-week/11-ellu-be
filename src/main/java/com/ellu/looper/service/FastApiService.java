...
public class FastApiService {
  ...
  public void sendNoteToAI(MeetingNoteRequest noteRequest,
      Consumer<MeetingNoteResponse> onSuccess,
      Consumer<Throwable> onError) {
    log.info("Sending note to AI server for project: {}", noteRequest.getAuthorId());
    webClient.post()
        .uri("/ai/notes")
        ...
        .doOnSuccess(response -> {
          log.info("Successfully sent note to AI server for project: {}", noteRequest.getAuthorId());
        })
        .doOnError(error -> {
          log.error("Failed to send note to AI server for project: {}, error: {}", noteRequest.getAuthorId(), error.getMessage());
        })
  ...
  public Mono<String> getTaskPreview(Long projectId) {
    ...
    return webClient.get()
        ...
        .doOnError(error -> {
          log.error("Failed to get task preview from AI server for project: {}, error: {}", projectId, error.getMessage());
        });
  }
  ...
  public void createWiki(Long projectId, WikiRequest request) {
    ...
    webClient.post()
        ...
        .doOnError(error -> {
          log.error("Failed to create wiki for project: {}, error: {}", projectId, error.getMessage());
        })
        .subscribe();
  }
  ...
  public Mono<String> getWiki(Long projectId) {
    ...
    return webClient.get()
        ...
        .doOnError(error -> {
          log.error("Failed to get wiki for project: {}, error: {}", projectId, error.getMessage());
        });
  }
  ...
  public void updateWiki(Long projectId, WikiRequest request) {
    ...
    webClient.patch()
        ...
        .doOnError(error -> {
          log.error("Failed to update wiki for project: {}, error: {}", projectId, error.getMessage());
        })
        .subscribe();
  }
} 